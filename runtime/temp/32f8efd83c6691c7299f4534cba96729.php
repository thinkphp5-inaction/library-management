<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:118:"/Users/xialeistudio/PhpStormProjects/think5-inaction/library-management/public/../application/index/view/lend/add.html";i:1556017005;s:106:"/Users/xialeistudio/PhpStormProjects/think5-inaction/library-management/application/index/view/layout.html";i:1555820434;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
    ...
    <div class="panel-body">
        <form action="<?php echo url('do_add'); ?>" class="form-horizontal" method="post">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <select id="book_id" name="book_id" required class="form-control">
                        <?php if(is_array($books) || $books instanceof \think\Collection || $books instanceof \think\Paginator): $i = 0; $__LIST__ = $books;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$book): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $book['book_id']; ?>">[<?php echo $book['book_id']; ?>]<?php echo $book['title']; ?></option>
                ...
                <div class="col-md-4">
                    <select id="user_id" name="user_id" required class="form-control">
                        <?php if(is_array($users) || $users instanceof \think\Collection || $users instanceof \think\Paginator): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $user['user_id']; ?>">[<?php echo $user['phone']; ?>]<?php echo $user['realname']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="date" id="lending_date" name="lending_date" required class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label for="should_return_date" class="control-label col-md-1">应还日期</label>
                <div class="col-md-4">
                    <input type="date" id="should_return_date" name="should_return_date" required class="form-control">
                </div>
            </div>
            <div class="form-group">
