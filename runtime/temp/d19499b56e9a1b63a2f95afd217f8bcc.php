<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:121:"/Users/xialeistudio/PhpStormProjects/think5-inaction/library-management/public/../application/index/view/user/update.html";i:1556011334;s:106:"/Users/xialeistudio/PhpStormProjects/think5-inaction/library-management/application/index/view/layout.html";i:1555820434;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
...
<ol class="breadcrumb">
    ...
    <li><a href="<?php echo url('user/index'); ?>">读者管理</a></li>
    <li class="active">编辑读者</li>
</ol>
<div class="panel-default panel">
    <div class="panel-body">
        <form action="<?php echo url('do_update',['id'=>$user['user_id']]); ?>" class="form-horizontal" method="post">
            <div class="form-group">
                <label for="realname" class="control-label col-md-1">姓名</label>
                <div class="col-md-4">
                    <input type="text" value="<?php echo $user['realname']; ?>" class="form-control" id="realname" name="realname" placeholder="读者姓名" maxlength="20" required>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="text" value="<?php echo $user['phone']; ?>" class="form-control" name="phone" id="phone" required placeholder="读者手机" maxlength="11">
                </div>
            </div>
            <div class="form-group">
                <label for="remark" class="control-label col-md-1">备注</label>
                <div class="col-md-4">
                    <textarea name="remark" id="remark" class="form-control" rows="10"><?php echo $user['remark']; ?></textarea>
                </div>
            </div>
            <div class="form-group">
